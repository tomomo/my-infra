# ==========================================
# AlmaLinux 9 - PHP 8.4 & Node.js 22 Environment
...
# 4. PHP 8.4 / Node.js 22 / 開発ツールのインストール
# COPY --from を使わず、ビルド環境のアーキテクチャに追従させる
RUN microdnf module enable php:remi-8.4 nodejs:22 -y \
    && microdnf install -y --refresh \
       php-{cli,fpm,intl,mbstring,xml,zip,gd,mysqlnd,opcache,imap,pgsql,redis,devel} \
       nodejs npm \
